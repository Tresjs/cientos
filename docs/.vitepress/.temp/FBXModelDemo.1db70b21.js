...
import { b as bx, T as Tx } from "./DocsDemo.b6cdbb3e.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(TresCanvas), mergeProps(gl, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<TresPerspectiveCamera${ssrRenderAttr("position", [11, 11, 11])}${_scopeId}></TresPerspectiveCamera>`);
            _push2(ssrRenderComponent(unref(bx), null, null, _parent2, _scopeId));
            ssrRenderSuspense(_push2, {
              default: () => {
                _push2(ssrRenderComponent(unref(Tx), {
            ...
            return [
              createVNode("TresPerspectiveCamera", { position: [11, 11, 11] }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/components/FBXModelDemo.vue");
