...
import { normalizeColor, TresColor, useTres } from '@tresjs/core';
import { BackSide, BufferGeometry, Group, InstancedMesh, Mesh, SkinnedMesh, Vector2 } from 'three';
...
watch(() => [props.angle], () => { if (groupRef.value) updateMesh(groupRef.value) })
watch(() => [props.transparent, props.thickness, props.color, props.opacity, contextSize, props.screenspace, props.toneMapped, props.polygonOffset, props.polygonOffsetFactor], 
    () => updateMaterial(), 
    { immediate: true }
)
